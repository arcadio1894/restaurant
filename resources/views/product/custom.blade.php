...
@section('styles')
    ...
    <style>
        ...
        /* Estilo para el interruptor Extra */
        .custom-interruptor-extra {
            display: inline-block;
            margin-left: 10px;
        }
        ...
        /* Movimientos del interruptor cuando está apagado o prendido */
        #extraApagado:checked ~ .custom-interruptor-cuerpo .custom-interruptor-tecla {
            left: 0px;
        }

        #extraPrendido:checked ~ .custom-interruptor-cuerpo .custom-interruptor-tecla {
            left: 20px;
        }

        #extraPrendido:checked ~ .custom-interruptor-cuerpo {
            background-color: #A2DA6C;
        }

        /* Oculta las etiquetas dentro del interruptor cuando está activo o desactivado */
        #extraApagado:checked ~ .custom-interruptor-cuerpo .custom-interruptor-tecla label[for=extraPrendido] {
            display: none;
        }

        #extraPrendido:checked ~ .custom-interruptor-cuerpo .custom-interruptor-tecla label[for=extraApagado] {
            display: none;
        }

        /* Ocultar los radios dentro del interruptor extra */
        .custom-interruptor-extra input[type="radio"] {
            display: none;
        }

        /* Evita que los radios se muestren en el DOM pero se mantenga la funcionalidad */
        .custom-interruptor-extra input[type="radio"]:not(:checked) {
            opacity: 0;
        }
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                        <div class="card-body px-1">
                                            ...
                                            <div id="extraOptions" style="display: none;">
                                                ...
                                                <!-- Interruptor Extra -->
                                                <div class="custom-interruptor-extra">
                                                    <input type="radio" name="extraInterruptor" id="extraPrendido" checked>
                                                    <input type="radio" name="extraInterruptor" id="extraApagado" >
                                                    <div class="custom-interruptor-cuerpo">
                                                        <div class="custom-interruptor-tecla">
                                                            <label for="extraPrendido" title="Desactivado">___</label>
                                                            <label for="extraApagado" title="Activado">___</label>
                                                        </div>
                                                    </div>
                                                    <span id="extraText">Sin Extra</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                        <div class="card-body py-5 px-4">
                                            <div class="menus d-md-flex">
                                                <div class="menu-img img" style="background-image: url({{ asset('accordion/images/dinner-1.jpg') }});"></div>
                                                <div class="text">
                                                    <div class="d-flex">
                                                        <div class="one-half">
                                            ...
                                            <div class="menus d-md-flex">
                                                <div class="menu-img img" style="background-image: url({{ asset('accordion/images/dinner-2.jpg') }});"></div>
                                                <div class="text">
                                                    <div class="d-flex">
                                                        <div class="one-half">
                                                            <h3>Grilled Beef with potatoes</h3>
                                            ...
                                            <div class="menus d-md-flex">
                                                <div class="menu-img img" style="background-image: url({{ asset('accordion/images/dinner-3.jpg') }});"></div>
                                                <div class="text">
                                                    <div class="d-flex">
                                                        <div class="one-half">
                                                            <h3>Grilled Beef with potatoes</h3>
...
@section('scripts')
    ...
    <script>
        ...
        // Cuando el interruptor se cambia de estado
        $('input[name="extraInterruptor"]').on('change', function() {
            if ($('#extraPrendido').is(':checked')) {
                $('#extraText').text('Con Extra'); // Actualizar el texto a "Con Extra"
                $('.custom-interruptor-cuerpo').css('background-color', '#A2DA6C'); // Color de activado
            } else {
                $('#extraText').text('Sin Extra'); // Actualizar el texto a "Sin Extra"
                $('.custom-interruptor-cuerpo').css('background-color', 'white'); // Color de desactivado
            }
        });

        // Inicializar el estado al cargar la página
        if ($('#extraPrendido').is(':checked')) {
            $('#extraText').text('Con Extra');
            $('.custom-interruptor-cuerpo').css('background-color', '#A2DA6C');
        } else {
            $('#extraText').text('Sin Extra');
            $('.custom-interruptor-cuerpo').css('background-color', 'white');
        }
    </script>
@endsection
