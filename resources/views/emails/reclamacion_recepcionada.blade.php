...
<body>
<h1 style="font-size: 24px; text-align: center; font-family: Arial, sans-serif;">Estimado/a {{ $reclamacion->nombre }} {{ $reclamacion->apellido }}</h1>
<p style="font-size: 16px; text-align: center; font-family: Arial, sans-serif;">
    Hemos recibido tu reclamo con el código <strong>{{ $reclamacion->codigo }}</strong>. <br>
    Estamos analizando tu solicitud y te mantendremos informado sobre el estado del proceso.
</p>
